  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'custom-gradient-to-r': 'radial-gradient(ellipse at left, rgba(197, 202, 213, 0.15) 0%, rgba(255, 255, 255, 0) 70%)',
        'custom-gradient-to-b': 'linear-gradient(to bottom, rgba(197, 202, 213, 0.20) 0%, rgba(255, 255, 255, 0) 70%)',
