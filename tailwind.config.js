  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        "blurred-bg":
          "linear-gradient(180deg, rgba(4, 25, 29, 0) 0%, rgb(1 9 15 / 90%) 100%)",
        ...
        "transparent-circle":
          "linear-gradient(135deg,rgba(246,184,70,.4) 0%,rgba(246,184,70,.01) 100%)",
        "transparent-bg":
          "linear-gradient(135deg,rgba(246,184,70,.2) 0%,rgba(246,184,70,.01) 100%)",
      },
      boxShadow: {
