...
function SpecialHeading({ heading, icon }) {
  return (
    <div className="relative flex items-center gap-3 before:absolute before:bottom-0 before:start-0 before:w-full before:h-[1px] before:bg-custom-gradient-to-r">
