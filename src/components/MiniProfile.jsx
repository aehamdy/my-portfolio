...
function MiniProfile() {
  return (
    <section className="flex justify-between md:justify-center items-center py-2 md:py-5 px-4 md:px-2 bg-section-light dark:bg-section-dark md:rounded-t-xl duration-short">
