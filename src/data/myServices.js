export const myServices = [
    {heading: "Custom Web Development", content: "I develop custom websites tailored to your unique needs, bringing your vision to life with clean, well-structured code."},
    {heading: "Single Page Applications (SPA)", content: "Using React JS, I build dynamic, high-performance single-page applications that offer fast and interactive user experiences."},
    {heading: "Responsive Web Design", content: "I create responsive, mobile-first websites using HTML, CSS, and JavaScript, ensuring seamless user experiences across all devices."},
    ...
    {heading: "UI/UX Implementation", content: "I translate UI/UX designs into functional web pages, ensuring a user-centered approach to interface development that enhances usability."},
